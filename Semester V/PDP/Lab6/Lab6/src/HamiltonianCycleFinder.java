...
public class HamiltonianCycleFinder
{
    ...
    { //Starts he search for a Hamiltonian Cycle with node 0 and an empty path.
    ...
    public void search(int currentNode, ArrayList<Integer> path) throws Exception
    {
        ...
        for (int i = 0; i < graph.size(); i++)
        {
            ...
            {
                path.add(i);// we add it to the path and mark it as visited(temporarily remove the edge)
                ...
                final int node = i; // mark current node
