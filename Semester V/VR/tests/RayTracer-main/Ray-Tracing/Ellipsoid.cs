...
namespace rt
{
    public class Ellipsoid : Geometry
    {
        ...
        public override Intersection GetIntersection(Line line, double minDist, double maxDist)
        {
            ...
            // coef for quadratic equation for intersection
            ...
            if (Delta == 0.0d)
            {
                ...
                Vector n = new Vector(2 * (intersection.X - Center.X) / asq, 2 * (intersection.Y - Center.Y) / bsq, 2 * (intersection.Z - Center.Z) / csq).Normalize();
