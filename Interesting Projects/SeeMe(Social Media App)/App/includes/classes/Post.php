	...
	public function loadPostsFriends($data, $limit) {
		...
		if(mysqli_num_rows($data_query) > 0) {
				...
				<script>
					...
					$(document).ready(function() {
						...
						$('#post<?php echo $id; ?>').on('click', function() {
							bootbox.confirm("Ești sigur că vrei să ștergi postare?", function(result) {
			...
			if($count > $limit) 
				...
				$str .= "<input type='hidden' class='noMorePosts' value='true'><p style='text-align: centre;'> Nicio altă postare de afișat! </p>";
		}
			...
			$row = mysqli_fetch_array($data_query); 
				...
				<script>
					...
					$(document).ready(function() {
						...
						$('#post<?php echo $id; ?>').on('click', function() {
							bootbox.confirm("Ești sigur că vrei să ștergi postarea?", function(result) {
				...
				<?php
					...
					echo "<p>Nu poți vedea postarea pentru că nu ești prieten cu utilizatorul.</p>";
					return;
				}
		}
		else {
			echo "<p>Nicio postare găsită.</p>";
					return;
		}
