...
class Message {
	...
	public function getLatestMessage($userLoggedIn, $user2) {
		...
		$row = mysqli_fetch_array($query);
		$sent_by = ($row['user_to'] == $userLoggedIn) ? "Primit: " : "Trimis: ";
	...
	public function getConvosDropdown($data, $limit) {
		...
		if($count > $limit)
			...
			$return_string .= "<input type='hidden' class='noMoreDropdownData' value='true'> <p style='text-align: center;'>Niciun mesaj în așteptare!</p>";
