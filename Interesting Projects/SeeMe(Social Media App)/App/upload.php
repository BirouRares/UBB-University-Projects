...
***********************************************************/		
		...
		//create new image using correct php func			
			if($_FILES["image"]["type"] == "image/gif"){
				...
				$msg .= "Există o eroare în încărcarea fișierului. Te rugăm să încarci doar fișiere în format .jpg, .gif sau .png <br />";
			}
...
<div class="main_column column">
	...
	<div id="formExample">
	    ...
	    <form action="upload.php" method="post"  enctype="multipart/form-data">
	        ...
	        <input type="submit" value="Încarcă" style="width:85px; height:25px;" />
	    </form><br /><br />
	        ...
	        <div id="InfoArea" style="width:180px; height:150px; position:relative; overflow:hidden; margin:40px 0px 0px 40px; border:0px #666 solid; float:left;">	
	           <p style="margin:0px; padding:0px; color:#444; font-size:18px;">          
	                ...
	                <span style="font-size:14px;">
	                    Taie / modifică dimensiunea fotografiei. <br />
	                    După ce ești mulțumit apasă pe salvare.
